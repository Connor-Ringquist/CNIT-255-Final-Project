...
// TODO code application logic here
    ...
    public Game()
    {
        ...
        titleL = new JLabel("Lone Survivor");
        ...
        buttonstart = new JButton("Let's Play!");
   ...
   public void createGame(){
    ...
    {
        stagenum = "choosepath";
        gametextinfo.setText("You have crash landed from a plane malfunction and you are the lone survivor. Which option will you choose?");
        decison1.setText("Go out and explore");
        decison2.setText("Gather resources from wreckage");
        decison3.setText("Attempt SOS message");
    }
    
    public void explore()
    {
        gametextinfo.setText("You decided to go out and explore. In doing so, you discovered several parts of the land. Which do you choose to focus on?");
        decison1.setText("Go by the river");
        decison2.setText("Explore the dark cave");
        decison3.setText("Stay within the forest");
...
public void Begformercy()
   ...
   switch(stagenum){
       case "choosepath":
              switch (choicemake){
                  case "d1": explore();break;
                  case "d2": TakethePath2();break;
